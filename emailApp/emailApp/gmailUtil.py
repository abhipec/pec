...
def generateServiceToken():
    ...
    http = httplib2.Http(proxy_info = httplib2.ProxyInfo(socks.PROXY_TYPE_SOCKS5, '172.16.27.119', 9050, proxy_rdns = True))
...
def CreateMsgLabels():
  ...
  """
  return {'removeLabelIds': ['UNREAD'], 'addLabelIds': ['Label_28']}
